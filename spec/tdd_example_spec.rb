...
describe 'passed values should be reversed' do
  ...
  describe '.reverse_string' do
    it 'reverses the string passed' do
      reverse_string = Reverser.reverse_string('hello world')
      expect(reverse_string).to eql('dlrow olleh')
    end
  end
  ...
  describe '.reverse' do
    context 'when an array is passed' do
      it 'reverses the array' do
        reverse_array = Reverser.reverse([1,3,4,5])
        expect(reverse_array).to eql([5,4,3,1])
      end
    end
    ...
    context 'when a string is passed' do
      it 'reverses that string' do
        reverse_string = Reverser.reverse('hello world')
        expect(reverse_string).to eql('dlrow olleh')
      end
    end
  end 
